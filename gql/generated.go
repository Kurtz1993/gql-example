...
import (
	...
	"github.com/Kurtz1993/gql-example/gql/model"
...
func (ec *executionContext) _Query_inventory(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNInventory2ᚖgithubᚗcomᚋKurtz1993ᚋgqlᚑexampleᚋgqlᚋmodelᚐInventory(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_item(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalOItem2ᚕᚖgithubᚗcomᚋKurtz1993ᚋgqlᚑexampleᚋgqlᚋmodelᚐItemᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNInventory2githubᚗcomᚋKurtz1993ᚋgqlᚑexampleᚋgqlᚋmodelᚐInventory(ctx context.Context, sel ast.SelectionSet, v model.Inventory) graphql.Marshaler {
	return ec._Inventory(ctx, sel, &v)
}

func (ec *executionContext) marshalNInventory2ᚖgithubᚗcomᚋKurtz1993ᚋgqlᚑexampleᚋgqlᚋmodelᚐInventory(ctx context.Context, sel ast.SelectionSet, v *model.Inventory) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalNItem2ᚖgithubᚗcomᚋKurtz1993ᚋgqlᚑexampleᚋgqlᚋmodelᚐItem(ctx context.Context, sel ast.SelectionSet, v *model.Item) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) marshalOItem2ᚕᚖgithubᚗcomᚋKurtz1993ᚋgqlᚑexampleᚋgqlᚋmodelᚐItemᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Item) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNItem2ᚖgithubᚗcomᚋKurtz1993ᚋgqlᚑexampleᚋgqlᚋmodelᚐItem(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
